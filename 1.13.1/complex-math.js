/***** Complex Number Calculator 1.13.1 *****/
...
var functions = [];
functions.push(["add", add]);
functions.push(["mult", mult]);
functions.push(["div", div]);
...
functions.push(["sinh", sinh]);
functions.push(["cosh", cosh]);
...
functions.push(["re", re]);
functions.push(["Re", re]);
functions.push(["im", im]);
functions.push(["Im", im]);
functions.push(["conj", conj]);
